...
if __name__ == '__main__':
    ...
    destinationList = [nfrPath,tssPath,tesPath,cutPath,sutPath,xutPath,trnaPath,xelementPath,centromerePath,arsPath,memePath,fimoPath,allfeaturesPath,boundfeaturesPath,enrichedfeaturesPath,bamPath,peaksPath,filteredPeaksPath,subsectorPath,bigWigPath,bigBedPath,allEventsPath]
