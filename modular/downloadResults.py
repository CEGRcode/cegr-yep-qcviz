...
#
# modified for bioblend version 0.13.0
"""
Program to read a config file and WorkflowInvokeFile to download all the required heatmaps and composites for each sample in yepQcViz pipeline.
...
invoking workflow error handling :
https://github.com/galaxyproject/galaxy/issues/4399

Configuration files in python :
https://martin-thoma.com/configuration-files-in-python/

find the available disk space on the TERMINAL
        ...
        if hist['state'] == 'ok' or hist['state'] == 'queued' or hist['state'] == 'error':
            ...
            for dsid in datasets:
                ...
                if ds['file_ext'] == 'bam' and ds['name'].endswith('filtered.bam'):
                    ...
                    gi.datasets.download_dataset(ds['id'],file_path=downloadFilePath,use_default_filename=False,maxwait=12000)
