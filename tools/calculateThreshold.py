...
def load_Data(input_file, quantile, absolute, header, start_col, row_num, col_num):
...
python calculateThreshold.py -i <input file> -q <quantile>  -t <absolute tag threshold> -d <header T/F> -s <start column> -r <row num after compress> -l <col num after compress>'

Example:
python calculateThreshold.py -i test.tabular.split_line -q 0.9 -d T -s 2 -r 600 -l 300
"""
...
if __name__ == '__main__':
    ...
    if len(sys.argv) < 2 or not sys.argv[1].startswith("-"):
        ...
        # get arguments
    try:
        optlist, alist = getopt.getopt(sys.argv[1:], 'hi:o:q:t:c:d:s:r:l:')
    ...
    load_Data(input_file, quantile, absolute,
              header, start_col, row_num, col_num)
