...
if __name__ == '__main__':
    ...
    parser.add_argument(
        'totalTagRankOrder', help='totalTagRankOrder.csv file generated from makeMotifHeatmap script')
    ...
    rankOrder = open(args.totalTagRankOrder, 'r').readlines()[0].strip().split(",")
